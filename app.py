...
def predict_label(img_path):
    ...
    predicted_proba = round(prediction[predicted_class] * 100, 2)
    
    other_probas = {label: round(prob * 100, 2) for label, prob in zip(dic.values(), prediction) if label != predicted_label}
